...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await context.bot.send_message(chat_id=update.effective_chat.id, text="Escrevendo...")
    ...
    try:
        ...
        await context.bot.send_message(chat_id=update.effective_chat.id, text="Algo deu errado no dojo. Tente novamente.")
...
# Executa a aplicação com loop corrigido
